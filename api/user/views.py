...
def generate_token_token(length=10):
...
def signin(request):
    ...
    if len(password)<3:
        return JsonResponse({'error':'password needs to be atlest 3 character'})
...
def signout(request,id):
    ...
    return JsonResponse({'success':'You have been logout'})
